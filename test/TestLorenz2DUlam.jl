@testset "Lorenz2dUlam" begin
    ...
    @test in_interval(1, RigorousInvariantMeasures.Lorenz2D._Lorenz_one_dim_map(interval(1), 2.0, 3.0))
    @test in_interval(-1, RigorousInvariantMeasures.Lorenz2D._Lorenz_right_one_dim_map()
        interval(0),
        2.0,
        3.0,
    )
