...
function BZ()
    A_big = Interval{BigFloat}(
        BigFloat(
            "0.5060735690368223513195993710530479569801417368282037493809901142182256388277772",
        ),
    )
    ...
    B_big = Interval{BigFloat}(
        ...
        BigFloat(
            "0.02328852830307032296813220750095076307514120085284790788241849636951680283042265",
        ),
    )
    BZB = Interval{Float64}(B_big)
    C_big = Interval{BigFloat}(
        BigFloat(
            "0.121205692738975111744666848150620569782497212127938371936404761693002104361654",
        ),
    )
